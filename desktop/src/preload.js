...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  onScreenSharingStarted: (callback) => ipcRenderer.on('screen-sharing-started', callback),
  onScreenSharingStopped: (callback) => ipcRenderer.on('screen-sharing-stopped', callback),
  onScreenSharingError: (callback) => ipcRenderer.on('screen-sharing-error', callback),
