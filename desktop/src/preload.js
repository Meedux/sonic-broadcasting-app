...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  startLivestream: (rtmpUrl) => ipcRenderer.invoke('start-livestream', rtmpUrl),
  ...
  deleteHLSSegment: (name) => ipcRenderer.invoke('delete-hls-segment', name),
  updateM3U8Playlist: (segments) => ipcRenderer.invoke('update-m3u8-playlist', segments),
  onStartHlsRecording: (callback) => ipcRenderer.on('start-hls-recording', callback),
  onStopHlsRecording: (callback) => ipcRenderer.on('stop-hls-recording', callback),
  notifyHlsStarted: () => ipcRenderer.send('hls-started'),
  notifyHlsError: (msg) => ipcRenderer.send('hls-error', msg),
});
